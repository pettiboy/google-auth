...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all",
  {
    variants: {
      variant: {
        default:
          "border border-border-light bg-[#F5F7FA] text-text-light shadow-md dark:border-border-dark dark:bg-[#333841] dark:text-text-dark dark:shadow-lg",
        destructive:
          "border border-error bg-error text-white dark:border-error-dark dark:bg-error-dark shadow-lg",
      },
    },
    defaultVariants: {
      variant: "default",
